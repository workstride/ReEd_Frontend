    ...
    <div className="menuBar" draggable="false">
      ...
      <ul>
        <Link to="/main" style={{ color: "white" }}>
          <li><img src="image/notification.svg" alt="notification" draggable="false" className="icon" />홈</li>
        </Link>
        ...
        <Link to="/qr" style={{ color: "white" }}>
          <li><img src="image/notification.svg" alt="notification" draggable="false" className="icon" />출석</li>
        </Link>
        <Link to="/signin" style={{ color: "white" }}>
          <li><img src="image/notification.svg" alt="notification" draggable="false" className="icon" />로그아웃</li>
        </Link>
      </ul>
    </div>
  );
